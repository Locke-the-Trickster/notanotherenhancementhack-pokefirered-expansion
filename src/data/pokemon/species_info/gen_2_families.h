...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_EFFECT_SPORE, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_PRANKSTER, ABILITY_FRISK },
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .baseDefense   = 50,
        .baseSpeed     = 70,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 99 : 99,
        .baseSpDefense = 96,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_STAMINA, ABILITY_SWARM },
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_HUGE_POWER, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 50,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 80 : 80,
        .baseSpDefense = 80,
    #if P_UPDATED_TYPES >= GEN_6
        .types = MON_TYPES(TYPE_WATER, TYPE_FAIRY),
    #else
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_SUDOWOODO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_ROCK_HEAD, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_SKILL_LINK, ABILITY_RUN_AWAY },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_AMBIPOM}),
    #endif
    },
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FLOWER_GIFT, ABILITY_DROUGHT, ABILITY_CHLOROPHYLL },
    #else
        .abilities = { ABILITY_FLOWER_GIFT, ABILITY_DROUGHT, ABILITY_SOLAR_POWER },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_YANMEGA}),
    #endif
    },
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .abilities = { ABILITY_UNAWARE, ABILITY_WATER_ABSORB, ABILITY_DAMP },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_PRANKSTER, ABILITY_SUPER_LUCK },
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_PRANKSTER, ABILITY_SUPER_LUCK },
    #endif
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_MOXIE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_MAGICIAN, ABILITY_MAGIC_GUARD, ABILITY_LEVITATE },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_FARIGIRAF}),
    #endif
    },
    ...
    [SPECIES_PINECO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_OVERCOAT, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_IMMUNITY, ABILITY_SAND_RUSH, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_SAND_RUSH, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STURDY, ABILITY_CONTRARY, ABILITY_GLUTTONY },
    #else
        .abilities = { ABILITY_STURDY, ABILITY_CONTRARY, ABILITY_GLUTTONY },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_MOXIE, ABILITY_GUTS, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKPOCKET, ABILITY_KEEN_EYE, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKPOCKET, ABILITY_KEEN_EYE, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GLUTTONY, ABILITY_QUICK_FEET, ABILITY_HONEY_GATHER },
    #else
        .abilities = { ABILITY_GLUTTONY, ABILITY_QUICK_FEET, ABILITY_HONEY_GATHER },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_FLAME_BODY, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_MAGCARGO}),
    },

    [SPECIES_MAGCARGO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 70 : 70,
        .baseAttack    = 60,
        .baseDefense   = 120,
        .baseSpeed     = 30,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 95 : 95,
        .baseSpDefense = 85,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SLUSH_RUSH, ABILITY_SNOW_CLOAK },
    #else
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_MAMOSWINE}),
    #endif
    },
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_FILTER, ABILITY_NATURAL_CURE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOODY, ABILITY_SNIPER, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_MOODY, ABILITY_SNIPER, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOODY, ABILITY_SNIPER, ABILITY_SUCTION_CUPS },
    #else
        .abilities = { ABILITY_MOODY, ABILITY_SNIPER, ABILITY_SUCTION_CUPS },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_SNOW_WARNING, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WATER_VEIL, ABILITY_WATER_ABSORB, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_MANTINE}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FULL_METAL_BODY, ABILITY_STURDY, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_FLASH_FIRE, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SAND_VEIL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SIMPLE, ABILITY_MOODY, ABILITY_TECHNICIAN },
    #else
        .abilities = { ABILITY_SIMPLE, ABILITY_MOODY, ABILITY_OWN_TEMPO },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_MULTISCALE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Lugia"),
        .cryId = CRY_LUGIA,
