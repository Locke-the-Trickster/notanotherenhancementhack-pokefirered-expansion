...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_MR_MIME}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_JYNX}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_ELECTABUZZ}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_MAGMAR}),
    },
#endif //P_GEN_2_CROSS_EVOS
