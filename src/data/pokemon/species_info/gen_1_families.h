...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_LEAF_GUARD, ABILITY_CHLOROPHYLL },
...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_TINTED_LENS, ABILITY_TINTED_LENS },
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_SNIPER, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_NO_GUARD, ABILITY_BIG_PECKS, ABILITY_TANGLED_FEET },
    #else
        .abilities = { ABILITY_NO_GUARD, ABILITY_BIG_PECKS, ABILITY_TANGLED_FEET },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_GALE_WINGS, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    {
        .baseHP        = 60,
        .baseAttack    = P_UPDATED_STATS >= GEN_7 ? 100 : 100,
        .baseDefense   = 69,
        .baseSpeed     = 80,
        .baseSpAttack  = 65,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 94 : 94,
        .types = MON_TYPES(TYPE_POISON),
        .catchRate = 90,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .baseAttack    = 100,
        .baseDefense   = 55,
        .baseSpeed     = P_UPDATED_STATS >= GEN_6 ? 105 : 105,
        .baseSpAttack  = 100,
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SAND_RUSH, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_SHEER_FORCE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .baseDefense   = 77,
        .baseSpeed     = 85,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 90 : 90,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_POISON, TYPE_GROUND),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_COMPETITIVE, ABILITY_FRIEND_GUARD },
    #else
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_COMPETITIVE, ABILITY_CUTE_CHARM },
    #endif
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_STENCH, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_STENCH, ABILITY_STENCH },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Gloom"),
        .cryId = CRY_GLOOM,
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EFFECT_SPORE, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_HEALER, ABILITY_HEALER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .baseDefense   = 55,
        .baseSpeed     = 25,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 60 : 60,
        .baseSpDefense = 55,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 30,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 70 : 70,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_BUG, TYPE_GRASS),
        .catchRate = 75,
    ...
    {
        .baseHP        = 35,
        .baseAttack    = P_UPDATED_STATS >= GEN_7 ? 105 : 105,
        .baseDefense   = 50,
        .baseSpeed     = 120,
...
#if P_FAMILY_MEOWTH
#if P_UPDATED_ABILITIES >= GEN_4
    #define MEOWTH_ABILITIES { ABILITY_LIMBER, ABILITY_TECHNICIAN, ABILITY_UNNERVE }
#else
    #define MEOWTH_ABILITIES { ABILITY_LIMBER, ABILITY_TECHNICIAN, ABILITY_PICKUP }
#endif
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .baseDefense   = 78,
        .baseSpeed     = 90,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 97 : 97,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_ANNIHILAPE}),
    #endif
    },
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEFIANT, ABILITY_ANGER_POINT, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_DRIZZLE, ABILITY_WATER_ABSORB, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_GLUTTONY, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .baseSpeed     = 45,
        .baseSpAttack  = 55,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 70 : 70,
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 248,
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_DEFIANT, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_LIMBER, ABILITY_VITAL_SPIRIT, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    #define GENGAR_ABILITIES {ABILITY_SHADOW_TAG, ABILITY_CURSED_BODY, ABILITY_LEVITATE}
#else
    #define GENGAR_ABILITIES {ABILITY_SHADOW_TAG, ABILITY_CURSED_BODY, ABILITY_LEVITATE}
#endif
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_BAD_DREAMS, ABILITY_FOREWARN },
    #else
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_HARVEST, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_UNBURDEN, ABILITY_RECKLESS, ABILITY_LIMBER },
    #else
        .abilities = { ABILITY_UNBURDEN, ABILITY_RECKLESS, ABILITY_LIMBER },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_UNSEEN_FIST, ABILITY_IRON_FIST, ABILITY_INNER_FOCUS },
    #else
        .abilities = { ABILITY_UNSEEN_FIST, ABILITY_IRON_FIST, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_ARMOR_TAIL, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_OVAL_STONE, SPECIES_BLISSEY}),
    #endif
    },
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_REGENERATOR, ABILITY_LEAF_GUARD, ABILITY_CHLOROPHYLL },
    #else
        .abilities = { ABILITY_REGENERATOR, ABILITY_LEAF_GUARD, ABILITY_CHLOROPHYLL },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_TANGROWTH}),
    #endif
    },
    ...
    [SPECIES_STARYU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_ANALYTIC, ABILITY_NATURAL_CURE, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_MR_MIME}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    #else
        .abilities = { ABILITY_SHARPNESS, ABILITY_TECHNICIAN, ABILITY_SWARM },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #else
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_TECHNICIAN, ABILITY_SWARM },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DRY_SKIN, ABILITY_HYDRATION, ABILITY_FOREWARN },
    #else
        .abilities = { ABILITY_DRY_SKIN, ABILITY_HYDRATION, ABILITY_OBLIVIOUS },
    #endif
        .bodyColor = BODY_COLOR_PINK,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_JYNX}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_ELECTABUZZ}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_NO_GUARD, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magby"),
        .cryId = CRY_MAGBY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_MAGMAR}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOXIE, ABILITY_MOLD_BREAKER, ABILITY_HYPER_CUTTER },
    #else
        .abilities = { ABILITY_MOXIE, ABILITY_MOLD_BREAKER, ABILITY_HYPER_CUTTER },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_RATTLED, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DITTO] =
    {
        ...
        .abilities = { ABILITY_IMPOSTER, ABILITY_NONE, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ditto"),
        .cryId = CRY_DITTO,
...
#if P_FAMILY_EEVEE
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 55 : 55)

#if P_UPDATED_ABILITIES >= GEN_4
    #define EEVEE_ABILITIES { ABILITY_MINDS_EYE, ABILITY_ADAPTABILITY, ABILITY_ANTICIPATION }
#else
    #define EEVEE_ABILITIES { ABILITY_MINDS_EYE, ABILITY_ADAPTABILITY, ABILITY_RUN_AWAY }
#endif
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                ,{EVO_ITEM, ITEM_PRISM_SCALE, SPECIES_SYLVEON}
                            #endif
                            #if P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_HYDRATION, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_LIGHTNING_ROD, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_MAGIC_BOUNCE, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TRIAGE, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_STAMINA, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_ICE_SCALES, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PIXILATE, ABILITY_TRIAGE, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_ANALYTIC, ABILITY_DOWNLOAD, ABILITY_TRACE },
    #else
        .abilities = { ABILITY_ANALYTIC, ABILITY_DOWNLOAD, ABILITY_TRACE },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WEAK_ARMOR, ABILITY_SHELL_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_SNOW_CLOAK, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_STATIC, ABILITY_STATIC },
    #else
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_FLAME_BODY, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_MULTISCALE, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_BERSERK, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_PRANKSTER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
