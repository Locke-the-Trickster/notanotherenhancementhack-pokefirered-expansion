...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_MOLD_BREAKER, ABILITY_DAMP },
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_QUICK_FEET, ABILITY_RUN_AWAY },
    #else
        .abilities = { ABILITY_RATTLED, ABILITY_QUICK_FEET, ABILITY_RUN_AWAY },
    #endif
    ...
    #else
        .abilities = { ABILITY_INTIMIDATE, ABILITY_STRONG_JAW, ABILITY_QUICK_FEET },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SUPERSWEET_SYRUP, ABILITY_RIVALRY },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_COMPOUND_EYES, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_SCRAPPY, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_HYDRATION, ABILITY_CLOUD_NINE, ABILITY_RAIN_DISH },
    #else
        .abilities = { ABILITY_HYDRATION, ABILITY_CLOUD_NINE, ABILITY_KEEN_EYE },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_HYDRATION, ABILITY_DRIZZLE, ABILITY_RAIN_DISH },
    #else
        .abilities = { ABILITY_HYDRATION, ABILITY_DRIZZLE, ABILITY_KEEN_EYE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_GARDEVOIR}
                                ...
                                ,{EVO_LEVEL, 30, SPECIES_GALLADE, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_ROLLING_KICK, 20})}
                            #endif
                            ),
    },
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_SCRAPPY, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_ANALYTIC, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_THICK_FAT, ABILITY_ANALYTIC, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_PROBOPASS, CONDITIONS({IF_IN_MAPSEC, MAPSEC_POWER_PLANT})},
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_TINTED_LENS, ABILITY_OBLIVIOUS },
    #else
        .abilities = { ABILITY_PRANKSTER, ABILITY_TINTED_LENS, ABILITY_OBLIVIOUS },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_WATER_VEIL, ABILITY_RAIN_DISH, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SOLID_ROCK, ABILITY_MAGMA_ARMOR },
    #else
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_MAGIC_BOUNCE, ABILITY_MAGICIAN },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PURE_POWER, ABILITY_CONTRARY, ABILITY_OWN_TEMPO },
    #else
        .abilities = { ABILITY_PURE_POWER, ABILITY_CONTRARY, ABILITY_TANGLED_FEET },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = TRAPINCH_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_SAND_RUSH, ABILITY_SAND_STREAM, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_WATER_ABSORB, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IMMUNITY, ABILITY_TOXIC_BOOST, ABILITY_TOXIC_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SIMPLE, ABILITY_SWIFT_SWIM, ABILITY_HYDRATION },
    #else
        .abilities = { ABILITY_SIMPLE, ABILITY_SWIFT_SWIM, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_ADAPTABILITY, ABILITY_SHELL_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_STORM_DRAIN, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SWIFT_SWIM, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_MULTISCALE, ABILITY_COMPETITIVE },
    #else
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_MULTISCALE, ABILITY_CUTE_CHARM },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_LIBERO, ABILITY_PROTEAN, ABILITY_COLOR_CHANGE },
    #else
        .abilities = { ABILITY_LIBERO, ABILITY_PROTEAN, ABILITY_COLOR_CHANGE },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_PRANKSTER, ABILITY_FRISK },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_FRISK, ABILITY_CURSED_BODY, ABILITY_LEVITATE },
    #else
        .abilities = { ABILITY_FRISK, ABILITY_CURSED_BODY, ABILITY_LEVITATE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_CURSED_BODY, ABILITY_FRISK },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_CURSED_BODY, ABILITY_FRISK },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_FILTER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_CHIMECHO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .baseAttack    = 50,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 90 : 90,
        .baseSpeed     = 65,
        .baseSpAttack  = 100,
    ...
    [SPECIES_SNORUNT] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_ICE_FACE, ABILITY_MOODY, ABILITY_ICE_BODY },
    #else
        .abilities = { ABILITY_ICE_FACE, ABILITY_MOODY, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_ICE_STONE, SPECIES_GLALIE}
                            #if P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SEALEO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_WALREIN}),
    },
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_WEAK_ARMOR, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_HYDRATION, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SHEER_FORCE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Bagon"),
        .cryId = CRY_BAGON,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_LIGHT_METAL, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_STURDY, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_ICE_BODY, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_HEALER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_COMPETITIVE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
