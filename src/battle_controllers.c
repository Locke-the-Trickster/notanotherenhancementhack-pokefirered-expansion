...
static inline bool32 IsControllerPokedude(enum BattlerId battler)
{
...
static bool8 ShouldDoSlideInAnim(enum BattlerId battler)
{
    ...
    if (gBattleTypeFlags & (
        ...
        BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_RECORDED | BATTLE_TYPE_TRAINER_TOWER | BATTLE_TYPE_POKEDUDE)
    )
        return FALSE;
